---
title: Expo UI for Android
sidebar_title: Android
description: Jetpack Compose components that allow you to build native Android interfaces with Expo UI.
...
`@expo/ui` is a set of native input components that allows you to build fully native interfaces with SwiftUI and Jetpack Compose. This page covers the Jetpack Compose components for Android.
